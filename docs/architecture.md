...
edge behavior, including TAC write falling-edge increments. This keeps device
timing deterministic and prevents individual devices from advancing themselves
or consulting wall-clock time.
