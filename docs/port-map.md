...
| `Core/apu.c` | `ApuDevice` | partial | NR50/NR51 mixer routing, channel 1/2/4 envelope and sweep foundations, channel 3 frequency/wave RAM, four channel trigger/length/status, and bounded PCM mixing; hardware fidelity remains partial |
