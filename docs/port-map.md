...
| `Core/mbc.c` | `Cartridge` implementations | partial | ROM/MBC1/MBC1M/MBC2/MBC5/MBC3 banking and RAM tests; MMM01 startup mapping, lock, mask, multiplex, ROM/RAM banking, battery, and native-oracle coverage; HuC1 ROM/RAM banking and infrared-register endpoint/oracle coverage; HuC3 banking, nibble RTC/alarm commands, host-time advancement, infrared, SameBoy battery/BESS state, and oracle coverage; MBC3 RTC fixture, SameBoy-compatible battery format, and stream persistence |
