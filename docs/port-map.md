...
| `Core/memory.c` | `Emulator.Read/Write` | partial | native CGB-family SVBK work-RAM banking, VRAM, WRAM, echo-RAM, general and HBlank DMA timing/block transfers with stop-request/LCD-disable cancellation, OAM DMA progress hashing, cartridge mapper/RTC control-state and ROM-identity hashing, DMG unusable-range, absolute/high-page, and auto-indexed CPU transfer comparisons |
