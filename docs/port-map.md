...
| `Core/save_state.c` | `InputRecording` / BESS | partial | versioned input recording, exact-cycle replay, DMG/MGB/CGB checkpoint-hash replay coverage, invalid-field/truncation/trailing-data validation, and deterministic hashing including cartridge state; full BESS state remains deferred |
