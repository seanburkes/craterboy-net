...
| `Core/display.c` | `PpuDevice` | partial | LCD mode timing, LY/LYC/STAT interrupts, DMG background/window/sprite tile and palette rendering, and raw frame-buffer tests |
