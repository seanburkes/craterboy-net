...
| `Core/apu.c` | `ApuDevice` | partial | NR52 power gate, four channel trigger/length/status foundations, channel 3 wave RAM, channel 4 noise LFSR, and bounded PCM mixing; hardware fidelity remains partial |
