...
| `Core/apu.c` | `ApuDevice` | partial | NR52 power gate, channel-register routing, channel 1 trigger/length/envelope/sweep status, and bounded PCM emission; remaining channels/mixing deferred |
