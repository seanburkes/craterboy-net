...
| `Core/apu.c` | `ApuDevice` | partial | NR50/NR51 mixer routing, NR52 power gate, four channel trigger/length/status foundations, wave RAM/noise, and bounded PCM mixing; hardware fidelity remains partial |
