...
| `Core/timing.c`, timer portions of `Core/gb.c` | `TimerDevice` | partial | divider cadence, timer falling-edge, TAC write glitch, delayed TIMA reload window, and overflow interrupt tests |
