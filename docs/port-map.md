...
| `Core/display.c` | `PpuDevice` | partial | LCD mode timing, LY/LYC/STAT interrupts, DMG background/window/sprite tile and palette rendering including 8×16 sprites, and raw frame-buffer tests |
