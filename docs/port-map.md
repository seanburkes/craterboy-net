...
| `Core/apu.c` | `ApuDevice` | partial | NR52 power gate, channel 1/2 timing, channel 3 wave RAM/trigger/length, and bounded PCM mixing; remaining channel 4/mixing fidelity deferred |
