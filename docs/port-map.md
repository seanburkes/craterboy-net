...
| `Core/memory.c` | `Emulator.Read/Write` | partial | native CGB SVBK work-RAM banking, VRAM, WRAM, echo-RAM, CGB general and HBlank DMA block transfers, DMG unusable-range, absolute/high-page, and auto-indexed CPU transfer comparisons |
