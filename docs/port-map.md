...
| MBC3/RTC interoperability and remaining mappers | cartridge subsystem | deferred/partial | deterministic managed RTC exists; BESS MBC3 live/latched RTC state now round-trips through `Emulator.SaveBess`/`LoadBess`; SameBoy battery/RTC byte-format parity remains deferred |
