...
| timer, joypad, serial, DMA | device state/scheduler | partial | timer, OAM DMA bus blocking and transfer, internal/external serial clocks, DMG/MGB JOYP selection delay, and FF00 joypad edge tests |
