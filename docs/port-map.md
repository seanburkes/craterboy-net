...
| `Core/apu.c` | `ApuDevice` | partial | NR50/NR51 mixer routing, channel 1/2 envelope and sweep foundations, four channel trigger/length/status, wave RAM/noise, and bounded PCM mixing; hardware fidelity remains partial |
