...
| `Core/apu.c` | `ApuDevice` | partial | NR52 power gate, channel 1 trigger/length/envelope/sweep, channel 2 trigger/length, and bounded PCM mixing; remaining channels deferred |
