...
| `Core/display.c` | `PpuDevice` | partial | LCD mode timing/reset, SCX fine-scroll mode-3 penalty, edge-triggered LY/LYC/STAT interrupts, CPU VRAM/OAM access blocking, DMG background/window/sprite tile and palette rendering including 8×16 sprites and overlap priority, and raw frame-buffer tests |
